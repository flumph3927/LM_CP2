...
def main():
    ...
    book=file_saves.amalgamate(file_saves.load('individual/class_relationships/docs/students.json'))
    #loop
    while True:
        ...
        if choice=='1':
            ...
            #save
            file_saves.save(book,'individual/class_relationships/docs/students.json')
            #break ou of loop
            break
